     ...
     <Card className="bg-black/20 border-primary/30">
         <CardHeader>
            <CardTitle className="font-headline text-primary/90 text-md flex items-center justify-between">
                ...
                <span className="font-mono text-lg text-green-400">{successProbability} Success</span>
            </CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
            <div>
                <div className="flex justify-between items-center mb-1">
                    ...
                    <span className={cn("font-mono text-lg font-bold", confidenceColor)}>{confidenceScore}%</span>
                </div>
